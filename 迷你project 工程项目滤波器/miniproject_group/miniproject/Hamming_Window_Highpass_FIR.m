function [outputafterLPF,f,originalfrequency,originaloutput]=Hamming_Window_FIR_HIGHPASS(fs,Wp,Wp3,Ws,Ws3)
close all
...
[win Nwin]=Hamming_window(fs,TW);       %Step 3: generate hanning window function 生成矩形窗函数
...
[win3 Nwin3]=Hamming_window3(fs,TW3);       %Step 3: generate hanning window function 生成矩形窗函数
