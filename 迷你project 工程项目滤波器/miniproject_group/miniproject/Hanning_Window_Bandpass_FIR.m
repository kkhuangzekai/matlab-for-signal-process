function [outputafterLPF,f,originalfrequency,originaloutput]=Hanning_Window_FIR_BANDPASS(fs,Wp,Wp3,Ws,Ws3)
close all
...
[win Nwin]=Hanning_window(fs,TW);       %Step 3: generate hanning window function 生成矩形窗函数
...
[win3 Nwin3]=Hanning_window3(fs,TW3);       %Step 3: generate hanning window function 生成矩形窗函数
